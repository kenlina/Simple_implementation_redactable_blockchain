...
time_redact: chameleon_hash_ateniese04a.c redact_time.c
	...
	gcc -g -Wall -O2  redact_time.o -o redact_time -lm -lcrypto
	rm -rf *.o

time_sha256:
	gcc -Wall -O2 sha256_time.c -o sha256_time -lcrypto  -lm
...
redact: chameleon_hash_ateniese04a.c redactable_blockchain.c
	...
	gcc -g -Wall -O2  redactable_blockchain.o -o redactable_blockchain -lm -lcrypto
	rm -rf *.o
